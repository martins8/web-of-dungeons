import Stats, { StatsProps } from "src/game/value-objects/stats";
import { AttributesProps } from "src/game/value-objects/attributes";
...
export default class StatsCalculator {
  static calculate(attributes: AttributesProps): Stats {
